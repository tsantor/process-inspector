...
from process_inspector import __all__ as exported_symbols
from process_inspector import __version__

DIST_DIR = Path("dist")
PACKAGE_NAME = "process-inspector"
PACKAGE_DIR = "process_inspector"
